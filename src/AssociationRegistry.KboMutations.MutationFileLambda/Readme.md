...
```
    cd "AssociationRegistry.KboMutations.MutationFileLambda/test/AssociationRegistry.KboMutations.MutationFileLambda.Tests"
    dotnet test
```
...
```
    cd "AssociationRegistry.KboMutations.MutationFileLambda/src/AssociationRegistry.KboMutations.MutationFileLambda"
