...
Execute unit tests
```
    cd "AssociationRegistry.KboMutations.Fetcher/test/AssociationRegistry.KboMutations.Fetcher.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "AssociationRegistry.KboMutations.Fetcher/src/AssociationRegistry.KboMutations.Fetcher"
