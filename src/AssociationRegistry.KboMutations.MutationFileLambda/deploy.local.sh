...
#mv ./bin/Release/net8.0/AssociationRegistry.KboMutations.MutationFileLambda.zip ../../.localstack/lambda/mutationfile.zip
...
ZIP_FILE_PATH="fileb://bin/Release/net8.0/AssociationRegistry.KboMutations.MutationFileLambda.zip"
EVENT_SOURCE_ARN="arn:aws:sqs:us-east-1:000000000000:verenigingsregister-kbomutations-mutationfile"
BATCH_SIZE=1
