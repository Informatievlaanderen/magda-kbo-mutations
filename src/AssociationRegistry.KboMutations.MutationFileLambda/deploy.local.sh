...
#mv ./bin/Release/net7.0/AssociationRegistry.KboMutations.MutationFileLambda.zip ../../.localstack/lambda/mutationfile.zip
...
ZIP_FILE_PATH="fileb://bin/Release/net7.0/AssociationRegistry.KboMutations.MutationFileLambda.zip"
