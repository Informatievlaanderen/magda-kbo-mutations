...
WORKDIR /src
COPY ["AssociationRegistry.KboMutations.MutationLambdaContainer.csproj", "AssociationRegistry.KboMutations.MutationLambdaContainer/"]
RUN dotnet restore "AssociationRegistry.KboMutations.MutationLambdaContainer/AssociationRegistry.KboMutations.MutationLambdaContainer.csproj"

WORKDIR "/src/AssociationRegistry.KboMutations.MutationLambdaContainer"
COPY . .
RUN dotnet build "AssociationRegistry.KboMutations.MutationLambdaContainer.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "AssociationRegistry.KboMutations.MutationLambdaContainer.csproj" \
...
Execute unit tests
```
cd "AssociationRegistry.KboMutations.MutationLambdaContainer/test/AssociationRegistry.KboMutations.MutationLambdaContainer.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "AssociationRegistry.KboMutations.MutationLambdaContainer/src/AssociationRegistry.KboMutations.MutationLambdaContainer"
